...
@property (strong, nonatomic) IBOutlet UILabel *markerLocationHelpLabel;

@property (strong, nonatomic) IBOutlet UIImageView *stationaryMarkerIcon;

@property (strong, nonatomic) IBOutlet UIButton *centerPositionButton;
