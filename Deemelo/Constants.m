         ...
         commentAuthorEmail:(NSString *)commentAuthorEmail
{
    ...
    return [NSURL URLWithString:[[NSString stringWithFormat:@"%@newcomentario&content=%@&post_id=%@&user=%@&email=%@", [Constants URLStringWithToken], comment, picture_id, commentAuthorName, commentAuthorEmail] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
}
