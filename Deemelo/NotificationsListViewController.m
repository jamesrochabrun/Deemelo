...
//    [cell setSelectedBackgroundView:selectedView];
    ...
    // Setear referencias a los controles de la celda
    ...
    [[cell notificationMessageButton] setBackgroundImage:[CommonUtilities imageFromColor:[UIColor colorWithRed:230.0/255
                                                                                                         green:226.0/255
                                                                                                          blue:215.0/255
                                                                                                         alpha:0.5f]]
...
- (void)didSelectAvatar:(id)sender
...
{    
    ...
    // Cargo una referencia a la vista del Storyborad que muestra un perfil de usuario
    id targetVC = [[self myStoryboard] instantiateViewControllerWithIdentifier:@"profileViewController"];
...
-(void)didSelectNotificationMessage:(id)sender
                        atIndexPath:(NSIndexPath *)indexPath
{    
    // Obtengo una referencia a la notificación
    Notification *notification = [[self collection] objectAtIndex:[indexPath row]];
