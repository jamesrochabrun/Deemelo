...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    // agregar la pagina web de la tienda
    if ([[self selectedStore] webPage])
        [[self storeWebAddressButton] setTitle:[[self selectedStore] webPage] forState:UIControlStateNormal];
...
- (IBAction)didSelectStoreWebPage:(id)sender
{
    NSURL *url = [NSURL URLWithString:[[self selectedStore] email]];
