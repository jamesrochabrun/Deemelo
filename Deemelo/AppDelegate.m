...
{
    // configuramos el token de mixpanel de la aplicacion
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    // #trackeamos el evento cuando el usuario abre o vuelve del foreground a la aplicacion
    // comprobamos que los datos del usuario ya esten guardados
    if ([self currentUser])
        [MixpanelTracker trackEvent:USER_OPEN_APP];
}
