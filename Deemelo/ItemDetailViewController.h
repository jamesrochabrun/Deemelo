...
@interface ItemDetailViewController : UIViewController <UIAlertViewDelegate, UINavigationBarDelegate, UINavigationControllerDelegate, UITableViewDelegate, UITableViewDataSource, YIPopupTextViewDelegate, UITextFieldDelegate>
...
@property (strong, nonatomic) IBOutlet UIButton *anotherStoresButton;
